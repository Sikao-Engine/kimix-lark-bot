...
# @version 1.0
# ---------------------------------
"""kimix_lark_bot.opencode.compatibility — 检查命令行工具是否兼容 opencode serve API。
...
Usage::
    ...
    from kimix_lark_bot.opencode.compatibility import check_cli_compatibility
...
from kimix_lark_bot.opencode.client import check_health_sync
