...
from kimix_lark_bot.session_state import RiskLevel, classify_risk
...
class MessageHandler(BaseHandler):
    ...
    def handle(self, data: lark.im.v1.P2ImMessageReceiveV1) -> None:
        ...
        try:
            ...
            from kimix_lark_bot.log_formatter import user_message
    ...
    def _dispatch_message(
        ...
        if (
            ...
            from kimix_lark_bot.context import PendingConfirmation
