...
v2.0: 使用 kimix_lark_bot.opencode 基础设施层替代旧的 session_manager/async_task_manager。
"""
...
if TYPE_CHECKING:
    from kimix_lark_bot.messaging.client import FeishuMessagingClient
    ...
    from kimix_lark_bot.opencode import OpenCodeProcessManager
