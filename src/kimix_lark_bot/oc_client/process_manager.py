...
# @version 1.0
# ---------------------------------
"""kimix_lark_bot.oc_client.process_manager — opencode serve 进程生命周期管理。
...
from kimix_lark_bot.oc_client.client import check_health_sync
    ...
    def get_or_create_api_session(self, path: str) -> Optional[str]:
        ...
        try:
            ...
            with httpx.Client(timeout=10.0) as c:
                ...
                from kimix_lark_bot.oc_client.client import Session
