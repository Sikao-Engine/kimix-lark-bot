...
# @version 1.0
# ---------------------------------
"""kimix_lark_bot.oc_client.sse_printer — SSE 事件可视化打印器。
...
使用示例::
    ...
    from kimix_lark_bot.oc_client.sse_parser import EventType
...
from kimix_lark_bot.oc_client.sse_parser import EventType, ParsedEvent
